    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "זמני שבת אברהם יהודה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '1f9987e3-4a89-4ae4-ae02-076b80863dc9',
                    name: data.name || '',
                    email: data.email || '',
